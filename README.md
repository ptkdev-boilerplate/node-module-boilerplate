...
[![WebComponent: SvelteWebComponentBoilerplate](https://raw.githubusercontent.com/ptkdev-boilerplate/node-module-boilerplate/main/.github/assets/screenshot.png)](https://raw.githubusercontent.com/ptkdev-boilerplate/node-module-boilerplate/main/.github/assets/screenshot.png)
...
```html
<node-module-boilerplate header="make" flip="svelte,webcomponents,opensource" footer="awesome!"></node-module-boilerplate>
```

2. Require javascript in yourpage (before `</body>`):

```html
<script src="https://cdn.jsdelivr.net/npm/@ptkdev/node-module-boilerplate@latest/dist/webcomponent.min.js"></script>
```
...
1. Install npm module: `npm install @ptkdev/node-module-boilerplate --save`
...
```javascript
require("@ptkdev/node-module-boilerplate");
```

or

```javascript
import "@ptkdev/node-module-boilerplate";
```
...
1. Download wordpress plugin from [mirror](https://github.com/ptkdev-components/node-module-boilerplate/raw/master/dist/wordpress/node-module-boilerplate-wordpress-plugin.zip) and install it.
...
1. Install npm module with `npm install @ptkdev/node-module-boilerplate@latest --save`:
...
| --------- | -------------------------------------------- | ------------------ | --------------------------------- | --------------- |
| header    | Setup top text                               | String             | `make`                            | v1.0.20210326   |
| flip      | Setup middle flip text (separte with commas) | String with commas | `svelte,webcomponents,opensource` | v1.0.20210326   |
| footer    | Setup bottom text                            | String             | `awesome!`                        | v1.0.20210326   |
...
```html
<style>
	node-module-boilerplate::part(flip) {
